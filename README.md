...
本项目基于 [py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi) 进行二次开发，继承其 **MIT 许可证**。根据 MIT 许可证的规定：

- 原项目版权归 Junsen 所有
- 二次开发中新添加的代码和功能归 StudyPet Team(Charlie-31-code,Mia-au,Xenia-www,Sylvia0601) 所有
- 对原项目代码的修改部分由原作者和二次开发团队共同拥有版权
